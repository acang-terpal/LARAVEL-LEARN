    ...
    init: function () {
        ...
        calcObj.worksheet = jspreadsheet(document.getElementById('spreadsheet'), {
            ...
            onbeforechange: function (instance, cell, x, y, value) {
                //tempBeforeChange = structuredClone(datasource[y][x]);
            },
        ...
        calcObj.worksheet.setStyle({'C6': 'background-color: #e8f584;',
        ...
        calcObj.worksheet.setStyle({'B10': 'background-color: #b79600;',
        ...
        calcObj.worksheet.setStyle({'E6': 'color: #4c4a4a;', 'E7': 'color: #4c4a4a;','E8': 'color: #4c4a4a;','E9': 'color: #4c4a4a', 'E10': 'color: #4c4a4a'}, null, null, true);
        calcObj.worksheet.setStyle({'F6': 'background-color: #a5e082; color: #4c4a4a', 'F7': 'background-color: #a5e082; color: #4c4a4a','F8': 'background-color: #a5e082; color: #4c4a4a','F9': 'background-color: #a5e082; color: #4c4a4a', 'F10': 'color: #4c4a4a'}, null, null, true);
        calcObj.worksheet.setStyle({'F6': 'background-color: #a5e082; color: #4c4a4a', 'F7': 'background-color: #a5e082; color: #4c4a4a','F8': 'background-color: #a5e082; color: #4c4a4a','F9': 'background-color: #a5e082; color: #4c4a4a', 'F10': 'color: #8d0303'}, null, null, true);
        calcObj.worksheet.setStyle({'G6': 'background-color: #a5e082; color: #4c4a4a', 'G7': 'background-color: #a5e082; color: #4c4a4a','G8': 'background-color: #a5e082; color: #4c4a4a','G9': 'background-color: #a5e082; color: #4c4a4a', 'G10': 'color: #4c4a4a'}, null, null, true);
        calcObj.worksheet.setStyle({'H6': 'background-color: #a5e082; color: #4c4a4a', 'H7': 'background-color: #a5e082; color: #4c4a4a','H8': 'background-color: #a5e082; color: #4c4a4a','H9': 'background-color: #a5e082; color: #4c4a4a', 'H10': 'color: #8d0303'}, null, null, true);
        calcObj.worksheet.setStyle({'I6': 'background-color: #a5e082; color: #4c4a4a'}, null, null, true);
        calcObj.worksheet.setStyle({'A3': 'color: #8d0303;'});
        calcObj.worksheet.setStyle({'B1': 'background-color: #8d0303; color: #f4f0f0;'});
        calcObj.worksheet.setStyle({'B3': 'background-color: #0f065a; color: #f4f0f0;',});
        calcObj.worksheet.setStyle({'A3': 'color: #8d0303;'});
        calcObj.worksheet.setMerge('A3', 0, 8);
        calcObj.worksheet.setMerge('B1', 8, 2);
        calcObj.worksheet.setMerge('B3', 8, 1);
        calcObj.worksheet.setMerge('I6', 0, 4);
    },
    negative: function (v) {
        return -1 * v;
    },
    callBe: function(script) {
        ...
        $.ajax({
            ...
            success:function(res) {
                calcObj.worksheet.setValue('H6', res.H6, true);
                calcObj.worksheet.setValue('H7', res.H7, true);
                calcObj.worksheet.setValue('H8', res.H8, true);
                calcObj.worksheet.setValue('H9', res.H9, true);
                calcObj.worksheet.setValue('H10', (res.H10 == null ? '#N/A': res.H10), true);
                console.log(res)
            },
            error:function(err) {
