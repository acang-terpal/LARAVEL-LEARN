...
class LoginController extends Controller
{
    public function getLoginPage(){
        ...
        for($i=0; $i < count($feature); $i++){
            ...
            // $geoMigas = new Geomigas();
            // $geoMigas->name = $feature[$i]->properties->name;
            // $geoMigas->color = $feature[$i]->properties->color;
            // $geoMigas->stat = $feature[$i]->properties->stat;
            // $geoMigas->area_sqkm = $feature[$i]->properties->area_sqkm;
            // $geoMigas->capacity_oil = $feature[$i]->properties->capacity_oil;
            // $geoMigas->capacity_gas = $feature[$i]->properties->capacity_gas;
            // $geoMigas->resource_oil_p50 = $feature[$i]->properties->resource_oil_p50;
            // $geoMigas->resource_gas_p50 = $feature[$i]->properties->resource_gas_p50;
            // $geoMigas->resource_mnk_oil = $feature[$i]->properties->resource_mnk_oil;
            // $geoMigas->resource_mnk_gas = $feature[$i]->properties->resource_mnk_gas;
            //if data type coloum is 2D
            // $geoMigas->geom = DB::raw("ST_Force2D(ST_AsEWKB(ST_SetSRID(ST_GeomFromGeoJSON('{$geoJsonStr}'), 4326)))");
            //if data type coloum is 3D
            // $geoMigas->geom = DB::raw("ST_AsEWKB(ST_SetSRID(ST_GeomFromGeoJSON('{$geoJsonStr}'), 4326))");
            //$geoMigas->save();
